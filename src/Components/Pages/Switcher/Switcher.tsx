...
import bg1 from '../../../assets/img/backgrounds/06.jpg';
import bg2 from '../../../assets/img/backgrounds/07.jpg';
import bg3 from '../../../assets/img/backgrounds/08.jpg';
import bg4 from '../../../assets/img/backgrounds/09.jpg';



const Switcher = ({ SwitcherAction, changePrimaryColor, transparentBackground, BGImagePrimaryColor }) => {
