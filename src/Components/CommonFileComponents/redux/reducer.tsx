...
export default function reducer(state = data, action): any {
    ...
    switch (type) {
        ...
        case 'DarkTheme':
           ...
           if(myonoffswitch55){ myonoffswitch55.checked = true;}
